# -*- encoding: utf-8 -*-
# stub: hoe-git 1.6.0 ruby lib

Gem::Specification.new do |s|
  s.name = "hoe-git".freeze
  s.version = "1.6.0"
  ...
  s.date = "2014-02-05"
  s.description = "A set of Hoe plugins for tighter Git integration. Provides tasks to\nautomate release tagging and pushing and changelog generation. I\nexpect it'll learn a few more tricks in the future.".freeze
  ...
  s.homepage = "http://github.com/jbarnette/hoe-git".freeze
  s.licenses = ["MIT".freeze]
  s.rdoc_options = ["--main".freeze, "README.rdoc".freeze]
  s.rubyforge_project = "hoe-git".freeze
